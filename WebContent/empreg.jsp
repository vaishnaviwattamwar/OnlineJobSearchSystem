...
String cd=String.valueOf(cl.get(Calendar.DATE))+"/"+String.valueOf(cl.get(Calendar.MONTH))+"/"+String.valueOf(cl.get(Calendar.YEAR));
	...
	try
	{
		...
		Connection con1=DriverManager.getConnection("jdbc:mysql://localhost:3306/project1","root","root");
		...
		Connection con2=DriverManager.getConnection("jdbc:mysql://localhost:3306/project1","root","root");
		...
		Connection con3=DriverManager.getConnection("jdbc:mysql://localhost:3306/project1","root","root");
		...
		Connection con4=DriverManager.getConnection("jdbc:mysql://localhost:3306/project1","root","root");
